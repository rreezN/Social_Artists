...
---
We have chosen to analyse the network of hip-hoppers since it is an interesting segment of musicians. Our hypothesis is 
that they tend to work and collaborate together a lot
...
The following shows an example of the raw data
| Title | Content | Links (URL) | Artist links | Categories |
|-------|---------|-------------|--------------|------------|
|2|a|b|2|a

![drake](/images/drake_extract.png)
